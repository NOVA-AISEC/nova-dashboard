          ...
          return (
            <div key={event.id} className="relative flex gap-4 pl-1">
              {index < events.length - 1 ? (
                <div className="absolute left-[1.125rem] top-10 h-[calc(100%-1rem)] w-px bg-border" />
              ) : null}
              <div className="relative z-10 flex h-9 w-9 items-center justify-center border border-foreground bg-background">
